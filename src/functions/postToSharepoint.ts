...
// async function fetchListItemEntityFullName(listPath: string) {
//   const response = await axios
//     .get<SharepointQueryResult<{ ListItemEntityTypeFullName: string }>>(`${listPath}/listItemEntityTypeFullName`, {
...
// function generateBodyWithMetadata(listItemEntityFullName: string, body?: {}) {
//   const bodyWithMetadata = {
//     __metadata: {
//       type: listItemEntityFullName,
//     },
//     ...body,
//   };
